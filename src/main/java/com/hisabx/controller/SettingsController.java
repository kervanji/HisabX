...
public class SettingsController {
    ...
    @FXML private Label receiptsCountLabel;
    ...
    private void handleRestoreBackup() {
        ...
        confirm.setContentText("سيتم استبدال جميع البيانات الحالية بالبيانات من النسخة الاحتياطية.\nهذا الإجراء لا يمكن التراجع عنه!");
                    ...
                    if ("حذف".equals(text.trim())) {
                        try {
                            ...
                            if (currentDb.exists()) {
                                ...
                                Files.copy(currentDb.toPath(), preResetBackup.toPath(), StandardCopyOption.REPLACE_EXISTING);
                            }
    ...
    private void handleExportSales() {
        exportToCSV("sales", () -> {
            ...
            for (Sale s : sales) {
                ...
                sb.append(s.getSaleDate() != null ? s.getSaleDate().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")) : "-").append(",");
